...
function getActiveTriggers(triggerElement) {
    const accordionRoot = triggerElement.closest('[data-blazix-base-ui-accordion-root]');
    ...
    for (const item of items) {
        ...
        if (item.closest('[data-blazix-base-ui-accordion-root]') !== accordionRoot) continue;
