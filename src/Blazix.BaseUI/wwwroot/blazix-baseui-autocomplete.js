...
const stateKey = Symbol.for('Blazix.BaseUI.Autocomplete.State');
const pendingInlineSelectionKey = Symbol.for('Blazix.BaseUI.Autocomplete.PendingInlineSelection');
