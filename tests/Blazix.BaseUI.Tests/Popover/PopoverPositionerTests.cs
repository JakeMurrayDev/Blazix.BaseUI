...
public class PopoverPositionerTests : BunitContext, IPopoverPositionerContract
{
    ...
    private RenderFragment CreatePositionerInPopover(
        ...
        Blazix.BaseUI.Side side = Blazix.BaseUI.Side.Bottom,
        Blazix.BaseUI.Align align = Blazix.BaseUI.Align.Center,
        double sideOffset = 0,
    ...
    {
        var cut = Render(CreatePositionerInPopover(side: Blazix.BaseUI.Side.Top));
    ...
    {
        var cut = Render(CreatePositionerInPopover(align: Blazix.BaseUI.Align.Start));
    ...
    {
        var cut = Render(CreatePositionerInPopover(side: Blazix.BaseUI.Side.Bottom));
    ...
    {
        var cut = Render(CreatePositionerInPopover(align: Blazix.BaseUI.Align.Center));
    ...
    {
        var cut = Render(CreatePositionerInPopoverWithModal(Blazix.BaseUI.Popover.PopoverModalMode.False));
    ...
    private RenderFragment CreatePositionerInPopoverWithModal(
        Blazix.BaseUI.Popover.PopoverModalMode modal)
    {
        return builder =>
        {
            builder.OpenComponent<PopoverRoot>(0);
