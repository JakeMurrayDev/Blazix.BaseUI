...
public class PopoverRootTests : BunitContext, IPopoverRootContract
{
    ...
    {
        var handle = new PopoverHandle<string>();
        PopoverRootPayloadContext? capturedContext = null;
        RenderFragment<PopoverRootPayloadContext> childContent = context =>
        {
        ...
        var cut = Render<PopoverRoot>(parameters => parameters
