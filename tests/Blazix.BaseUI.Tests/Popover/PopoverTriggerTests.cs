...
public class PopoverTriggerTests : BunitContext, IPopoverTriggerContract
{
    ...
    public Task DoesNotRenderFocusGuardsWhenModal()
    {
        ...
        var hasTriggerPreGuard = prevSibling?.HasAttribute("data-blazix-base-ui-focus-guard") == true;
        var hasTriggerPostGuard = nextSibling?.HasAttribute("data-blazix-base-ui-focus-guard") == true;
