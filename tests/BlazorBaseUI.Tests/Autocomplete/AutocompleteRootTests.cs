using BlazorBaseUI.Tests.Contracts.Autocomplete;
using Microsoft.AspNetCore.Components.Web;

namespace BlazorBaseUI.Tests.Autocomplete;

    public class AutocompleteRootTests : BunitContext, IAutocompleteRootContract
{
    private const string AutocompleteModule = "./_content/BlazorBaseUI/blazor-baseui-autocomplete.min.js";
