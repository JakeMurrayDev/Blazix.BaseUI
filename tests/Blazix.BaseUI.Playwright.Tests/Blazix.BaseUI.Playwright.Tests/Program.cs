using Blazix.BaseUI.Playwright.Tests.Components;
...
if (isTestExecution)
{
    ...
    var result = Xunit.MicrosoftTestingPlatform.TestPlatformTestFramework
        .RunAsync(args, Blazix.BaseUI.Playwright.Tests.SelfRegisteredExtensions.AddSelfRegisteredExtensions)
...
app.MapRazorComponents<App>()
    ...
    .AddAdditionalAssemblies(typeof(Blazix.BaseUI.Playwright.Tests.Client._Imports).Assembly);
