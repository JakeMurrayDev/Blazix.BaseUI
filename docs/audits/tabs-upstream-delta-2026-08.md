...
| Upstream | Verdict | Notes | Verified against |
|---|---|---|---|
| `9f7867437` #5279 | **split — see per-hunk table** | Two ports, one already-present, four skips. | `4b2a7923` + `1a2ca3c9f` · 2026-08-21 |
| `e00174866` #5306 | **(a) skip — React-specific** | No runtime content — a docs demo for animated panels. | `4b2a7923` + `1a2ca3c9f` · 2026-08-21 |
...
| `ee38be3e2` #5250 | **(a) skip — React-specific** | No user-observable symptom: store-selector code size. | Shipped bytes only; the rendered Tabs output is identical. | `4b2a7923` + `1a2ca3c9f` · 2026-08-21 |
| `006a72a99` #5341 | **(a) skip — React-specific** | No user-observable symptom observed: the commit relocates which React component owns a cleanup effect. | Recorded **revisit-on-symptom** per #158; no Tabs activation or panel-mount ordering divergence has been observed to date. | `4b2a7923` + `1a2ca3c9f` · 2026-08-21 |
